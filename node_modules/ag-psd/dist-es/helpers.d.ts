...
export declare function getLayerDimentions(layer: Layer): {
    width: number;
    height: number;
};
export declare function getChannels(tempBuffer: Uint8Array, layer: Layer, background: boolean, options: WriteOptions): ChannelData[];
