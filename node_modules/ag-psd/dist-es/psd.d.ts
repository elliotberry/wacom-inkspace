...
export declare type ResolutionUnit = 'PPI' | 'PPCM';
export declare type SizeUnit = 'Inches' | 'Centimeters' | 'Points' | 'Picas' | 'Columns';
...
export declare const enum MaskParameters {
    UserMaskDensity = 1,
    UserMaskFeather = 2,
    VectorMaskDensity = 4,
    VectorMaskFeather = 8
